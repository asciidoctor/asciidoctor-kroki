...
//
// Usage:
//   node scripts/changelog.js release <version>   Roll "## [Unreleased]" into a dated
//                                                 "## [<version>]" section and start a
//                                                 fresh, empty "## [Unreleased]" section.
//   node scripts/changelog.js notes <version>     Print the body of the "## [<version>]"
...
if (!version) {
  fail(`usage: node scripts/changelog.js <release|notes> <version>`)
}
if (command === 'release') {
  release(version)
